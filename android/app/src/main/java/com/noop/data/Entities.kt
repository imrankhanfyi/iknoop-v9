 ...
 *
 * `ord` (Room v21, #823) is the beat's EMISSION order within its (deviceId, ts) group — the position the
 ...
 *
 * NULL means "emission order unknown": every row written before v21, and any row from a source that
 ...
 * there as `v29-rr-ord`. (An earlier revision of this note said the Swift widening was still pending;
