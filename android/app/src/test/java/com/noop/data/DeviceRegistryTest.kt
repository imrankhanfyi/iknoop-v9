...
class DeviceRegistryTest {
    ...
    private class FakeRegistryDao : DeviceRegistryDao {
        ...
        override suspend fun deleteSleepAnnotationsFor(deviceId: String) { deletedTables += "sleepAnnotation" to deviceId }
    }
    ...
    fun deleteDeviceDataForAppleHealthFansOutToEveryDeviceScopedTableAndKeepsRegistry() = runBlocking {
        ...
        val expectedTables = setOf(
            ...
            "sleepStateSample", "labMarker", "liveSession", "dismissedWorkout", "dismissedSleep", "sleepAnnotation",
        )
